                ...
                >
                  ...
                  <div className="p-6 flex flex-col h-full z-10 relative">
                    <div className="flex justify-between items-center mb-6">
                      <FolderGit2 className="w-9 h-9 text-accent" />
                    ...
                    <ul className="flex flex-wrap gap-2 font-mono text-xs mt-auto">
                      {project.tech_stack.map((tech, i) => (
                        <li key={i} className="px-2 py-0.5 rounded border border-border text-foreground/50 hover:border-accent/50 hover:text-accent/80 transition-colors">{tech}</li>
                      ))}
                    </ul>
                  </div>
                </div>
